...
<div class="form-section">
        <div class="form-background">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST"> 
                ...
                <div><span name='msg'><?php //echo isset($msg); ?></span></div>
    </form>
            </div>
        </div>
    </div>
...
echo "<script type='text/javascript'>alert('Selected Date Range is Reserved. Please Select Other Date Range !!');</script>";
//$msg = 'Reserved';
} else {

echo "<script type='text/javascript'>alert('Selected Date Range is Available.. Please Continue'); windows.location.href='./index.php'</script>";
//echo 'Available.';
